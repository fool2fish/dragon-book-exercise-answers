...
Interpreter appears to directly execute the operations specified un the source program on the inputs supplied by the user instead of producing target programs.
...
Some other reasaons for compilers producing assembly-language rather than machine language are:

It makes code relocation much easier.
